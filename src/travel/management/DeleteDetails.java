...
public class DeleteDetails extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            c.s.executeUpdate("delete from personaldetails where username = '"+username+"'");
            c.s.executeUpdate("delete from packagedetails where username = '"+username+"'");
            c.s.executeUpdate("delete from hoteldetails where username = '"+username+"'");
            c.s.executeUpdate("delete from bookingdetails where username = '"+username+"'");
                    
               JOptionPane.showInternalMessageDialog(null, "Customer Details Deleted Successfully");
